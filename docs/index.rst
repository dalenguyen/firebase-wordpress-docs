...
- Integrate Firebase PRO - `v1.24.0`
...
- `Integrate Firebase Woocommerce <https://firebase-wordpress-docs.readthedocs.io/en/latest/extensions/woocommerce.html>`_ - `v1.1.0` (Extension)
