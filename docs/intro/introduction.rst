...
After downloading the `Integrate Firebase PRO <https://techcater.com/>`_ plugin, please follow the video in order to have better review of how to install and make use of this plugin in your WordPress site.
...
.. raw:: html
    ...
    <div style="position: relative; padding-bottom: 10%; height: 0; overflow: hidden; max-width: 100%; height: auto;">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/0C2bowb8fN0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>